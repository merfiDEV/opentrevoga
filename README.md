...
Приймаються ботом-підписником у **особистих повідомленнях** (`python -m botsrc`).
Юзербот також приймає `.sub` / `.unsub` (перехідний період), але розсилає лише бот.

| Команда (бот) | Команда (юзербот) | Дія |
|---|---|---|
| `/sub [СЛОВО]` | `.sub [СЛОВО]` | Підписатися на ключове слово |
| `/sub` | `.sub` | Показати мої підписки |
| `/unsub [СЛОВО]` | `.unsub [СЛОВО]` | Відписатися від ключового слова |
| `/unsub all` | `.unsub all` | Скинути всі підписки |
