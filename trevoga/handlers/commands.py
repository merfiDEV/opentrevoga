...
📌 Подписываться можно не только на типы вооружения
(БПЛА, Каб, РСЗВ, FPV, ракета, балістика, арта и др.),
но и на свой город или посёлок
(Краматорськ, Покровськ, Бахмут, Слов'янськ и т.д.)</blockquote>"""
